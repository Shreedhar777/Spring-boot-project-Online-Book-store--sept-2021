...
public class Billing {
	...
	public Billing(int id, String user_billing_city, String user_billing_country, String user_billing_name,
			String user_billing_state, String user_billing_street1, String user_billing_street2,
			String user_billing_zipcode) {
		super();
		this.id = id;
	...
	public Billing(int id, String user_billing_city, String user_billing_country, String user_billing_name,
			String user_billing_state, String user_billing_street1, String user_billing_street2,
			String user_billing_zipcode, Payment payment) {
		super();
		this.id = id;
		this.user_billing_city = user_billing_city;
		this.user_billing_country = user_billing_country;
	...
	public String toString() {
		return "Billing [id=" + id + ", user_billing_city=" + user_billing_city + ", user_billing_country="
				+ user_billing_country + ", user_billing_name=" + user_billing_name + ", user_billing_state="
				+ user_billing_state + ", user_billing_street1=" + user_billing_street1 + ", user_billing_street2="
				+ user_billing_street2 + ", user_billing_zipcode=" + user_billing_zipcode + ", payment=" + payment
				+ "]";
	}
